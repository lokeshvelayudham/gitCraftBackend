...
async function sendEmail({ type, name, otp, email }) {
  ...
  let info = await transporter.sendMail({
    ...
    to: email,
    subject: `${isSignUp ? "Sign Up" : "Forgot Password"}`,
    html: `
            <!DOCTYPE html>
            <html lang="en">
            <head>
                    ...
                    <div class="content">
                        ...
                        <p>${
                          isSignUp
                            ...
                            : "This is your temporary password, try"
                        } to verify your email address: ${email}</p>
                        <div class="otp">${otp}</div>
                        <p>${
                          isSignUp
                            ? "This OTP is valid for the next 10 minutes. If you did not request this, please ignore this email."
                            : "To activate your account, authenticate first using this temporary password!!"
                        }</p>
